...
const (
	worker = protogen.GoImportPath("git.dhgames.cn/svr_comm/kite/v2/server/worker")
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P(g.QualifiedGoIdent(worker.Ident("Dispatch.AddService")), `("`, fileName, `", "`, export(service.GoName), `", &`, export(service.GoName), "Service{handle: handle})")
	g.P("}")
	g.P()
